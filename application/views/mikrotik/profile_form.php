...
?>	
  ...
  <a class="btn btn-primary" href="<?= base_url('mikrotik/hotspot_profile')?>">Kembali ke home  </a>
  <hr>
  <form class="form-horizontal" name="frmtambah" method="post" action="<?php echo $form_action; ?>">
	...
	<div class="form-group">
		<label class="col-md-2 control-label"  for="txtname">Iddle Timeout</label>
		<div class="col-md-4">
			<input class="form-control" type="text" name="idle-timeout" id="idle-timeout" placeholder="idle-timeout" value="<?php if (isset($default['name'])) { echo $default['name']; } ?>">
			<?php echo form_error('idle-timeout', '<label class="control-label" for="idle-timeout">', '</label>'); ?>	
		</div>
	</div>
	 
	<div class="form-group">
		<label class="col-md-2 control-label"  for="txtname">Keepalive Timout</label>
		<div class="col-md-4">
			<input class="form-control" type="text" name="keepalive-timeout" id="keepalive-timeout" placeholder="keepalive-timeout" value="<?php if (isset($default['keepalive-timeout'])) { echo $default['keepalive-timeout']; } ?>">
	...
	<div class="form-group">
		<label class="col-md-2 control-label"  for="txtname">Shared Users</label>
		<div class="col-md-4">
			<input class="form-control" type="text" name="shared-users" id="shared-users" placeholder="shared-users" value="<?php if (isset($default['shared-users'])) { echo $default['shared-users']; } ?>">
			<?php echo form_error('shared-users', '<label class="control-label" for="shared-users">', '</label>'); ?>	
		</div>
	</div>

	<div class="form-group">
		<label class="col-md-2 control-label"  for="txtname">Rate Limit</label>
		<div class="col-md-4">
			<input class="form-control" type="text" name="rate-limit" id="rate-limit" placeholder="rate-limit" value="<?php if (isset($default['rate-limit'])) { echo $default['rate-limit']; } ?>">
